...
public class ExpertHeuristic extends Heuristic {
	...
	public ExpertHeuristic() {
		log = false;
	}
	
	public ExpertHeuristic(boolean log) {
		this.log = log;
	}
	
	public ExpertHeuristic(double[] weights) {
		this.log = false;
		this.weights = weights;
	}
	
	public ExpertHeuristic(double[] weights, boolean log) {
		this.log = log;
		this.weights = weights;
	}
